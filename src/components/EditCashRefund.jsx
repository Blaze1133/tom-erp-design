...
const EditCashRefund = ({ setCurrentPage }) => {
  ...
  const handleSave = () => {
    ...
    showToast('Cash Refund updated successfully!', 'success');
    setCurrentPage('view-cash-refunds');
  };
    ...
    <div className="sales-quotation">
      <div className="page-header">
        <div className="page-title">
          ...
          <h1>Edit Cash Refund {formData.refundNo}</h1>
        </div>
        ...
        <div className="form-section">
          ...
          {expandedSections.primary && (
            <div className="form-grid">
              ...
              <div className="form-group">
                <label className="form-label">REFUND # <span className="required">*</span></label>
                <input 
                  type="text" 
                  className="form-control"
              ...
              <div className="form-group" style={{ display: 'flex', gap: '1rem', alignItems: 'center', gridColumn: '1 / -1' }}>
                <label style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', cursor: 'pointer' }}>
                  <input 
                    type="checkbox" 
                    checked={formData.createCheck}
                    onChange={(e) => handleInputChange('createCheck', e.target.checked)}
                    style={{ width: '18px', height: '18px' }}
                  />
                  <span style={{ fontWeight: '600', fontSize: '0.875rem' }}>CREATE CHECK</span>
                </label>
                <label style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', cursor: 'pointer' }}>
                  <input 
                    type="checkbox" 
                    checked={formData.printCheck}
                    onChange={(e) => handleInputChange('printCheck', e.target.checked)}
                    style={{ width: '18px', height: '18px' }}
                  />
                  <span style={{ fontWeight: '600', fontSize: '0.875rem' }}>PRINT CHECK</span>
                </label>
              </div>
            </div>
          )}
              ...
              <tbody>
                {items.map((item, index) => (
                  <tr key={item.id}>
                    ...
                    <td><input type="text" className="form-control" value={item.units} style={{ width: '80px' }} /></td>
                    <td><input type="text" className="form-control" value={item.description} style={{ width: '150px' }} /></td>
                    <td><input type="text" className="form-control" value={item.priceLevel} style={{ width: '100px' }} /></td>
                    <td><input type="text" className="form-control" value={item.rate} style={{ width: '100px' }} /></td>
                    <td><input type="text" className="form-control" value={item.amount} style={{ width: '100px' }} /></td>
                    <td>
                      <select className="form-control" style={{ minWidth: '120px' }}>
                        <option value="">Select...</option>
                        <option value="GST_SG-9%">GST_SG-9%</option>
                        <option value="0.0%">0.0%</option>
                      </select>
                    </td>
                    <td><input type="text" className="form-control" value={item.taxRate} style={{ width: '80px' }} /></td>
                    <td><input type="text" className="form-control" value={item.grossAmt} style={{ width: '100px' }} /></td>
                    <td><input type="text" className="form-control" value={item.taxAmt} style={{ width: '100px' }} /></td>
                    <td><input type="text" className="form-control" value={item.options} style={{ width: '100px' }} /></td>
                    <td><input type="text" className="form-control" value={item.costEstimateType} style={{ width: '120px' }} /></td>
                    <td><input type="text" className="form-control" value={item.estExtendedCost} style={{ width: '120px' }} /></td>
                    <td><input type="text" className="form-control" value={item.itemCountryOfOrigin} style={{ width: '120px' }} /></td>
                    <td><input type="text" className="form-control" value={item.hsCode} style={{ width: '100px' }} /></td>
                  </tr>
                ))}
              </tbody>
            </table>
