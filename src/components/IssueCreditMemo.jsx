              ...
              <tbody>
                {items.map((item, index) => (
                  <tr key={item.id}>
                    ...
                    <td><input type="text" className="form-control" value={item.costEstimate} style={{ width: '100px' }} /></td>
                    <td><input type="text" className="form-control" value={item.estExtendedCost} style={{ width: '120px' }} /></td>
                    <td><input type="text" className="form-control" value={item.estGrossProfit} style={{ width: '120px' }} /></td>
                    <td><input type="text" className="form-control" value={item.estGrossProfitPercent} style={{ width: '100px' }} /></td>
                    <td>
