...
const ViewCashRefundDetail = ({ setCurrentPage }) => {
  ...
  const refundData = {
    refundNo: 'CR00001',
    customerProject: '1000 TEAM LEAD CONSTRUCTION PTE LTD',
    date: '1/1/2021',
        ...
        <div className="detail-title">
          ...
          <div>
            ...
            <div className="detail-subtitle">
              <span>{refundData.refundNo}</span>
              <span style={{ marginLeft: '1rem', color: '#666' }}>{refundData.customerProject}</span>
            </div>
          </div>
        </div>
          ...
          <div className="section-body">
            <div className="detail-grid">
              <div className="detail-field">
                <label>REFUND #</label>
                <div className="field-value">{refundData.refundNo}</div>
              </div>
              <div className="detail-field">
                <label>ACCOUNT</label>
                <div className="field-value">{refundData.account || '-'}</div>
              </div>
              <div className="detail-field">
                <label>CUSTOMER:PROJECT</label>
                <div className="field-value">{refundData.customerProject}</div>
              </div>
              <div className="detail-field">
                <label>MEMO</label>
                <div className="field-value">{refundData.memo || '-'}</div>
              </div>
              <div className="detail-field">
                <label>DATE</label>
                <div className="field-value">{refundData.date}</div>
              </div>
              <div className="detail-field">
                <label>POSTING PERIOD</label>
                <div className="field-value">{refundData.postingPeriod}</div>
              </div>
              <div className="detail-field">
                <label>EXCHANGE RATE</label>
                <div className="field-value">{refundData.exchangeRate}</div>
              </div>
              <div className="detail-field">
                <label>CURRENCY</label>
                <div className="field-value">{refundData.currency}</div>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="section-body">
            <div className="detail-grid">
              <div className="detail-field">
                ...
                <div className="field-value">{refundData.salesRep || '-'}</div>
              </div>
              <div className="detail-field">
                <label>SALES EFFECTIVE DATE</label>
                <div className="field-value">{refundData.salesEffectiveDate}</div>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="section-body">
            <div className="detail-grid">
              <div className="detail-field">
                ...
                <div className="field-value">{refundData.subsidiary}</div>
              </div>
              <div className="detail-field">
                <label>CLASS</label>
                <div className="field-value">{refundData.class || '-'}</div>
              </div>
              <div className="detail-field">
                <label>LOCATION</label>
                <div className="field-value">{refundData.location}</div>
              </div>
              <div className="detail-field">
                <label>DEPARTMENT</label>
                <div className="field-value">{refundData.department || '-'}</div>
              </div>
              <div className="detail-field">
                <label>CONTACT PERSON</label>
                <div className="field-value">{refundData.contactPerson || '-'}</div>
              </div>
            </div>
          </div>
        </div>
...
export default ViewCashRefundDetail;
