...
const PlantUploadDrawings = () => {
  ...
  // Sample drawing records for Plant
  const [drawingRecords] = useState([
    {
      id: 1,
      drawingName: 'PLANT-BLK01-L01',
      drawingType: 'Plant Assembly',
      uploadDrawing: 'PLANT-TOM-SQ-CT-BLK-1-001.dwg'
    },
    {
      id: 2,
      drawingName: 'PLANT-BLK01-L02',
      drawingType: 'Plant Assembly',
      uploadDrawing: 'PLANT-TOM-SQ-CT-BLK-1-002.pdf'
    },
    {
      id: 3,
      drawingName: 'PLANT-BLK02-L01',
      drawingType: 'Plant Assembly',
      uploadDrawing: 'PLANT-TOM-SQ-CT-BLK-2-001.dwg'
    },
    {
      id: 4,
      drawingName: 'PLANT-BLK02-L02',
      drawingType: 'Plant Assembly',
      uploadDrawing: 'PLANT-TOM-SQ-CT-BLK-2-002.pdf'
    },
    {
      id: 5,
      drawingName: 'PLANT-BLK03-L01',
      drawingType: 'Plant Assembly',
      uploadDrawing: 'PLANT-TOM-SQ-CT-BLK-3-001.dwg'
    }
  ]);
  ...
  const handleSubmit = () => {
    ...
    showToast('Plant drawing uploaded successfully!', 'success');
      ...
      <div className="quotation-container">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '2rem', marginBottom: '2rem' }}>
            ...
            <div className="form-group">
              ...
              >
                ...
                <option value="Plant Assembly">Plant Assembly</option>
        ...
        <div className="form-section">
          <div style={{ 
            ...
            <h3 style={{ margin: 0, fontSize: '1rem', fontWeight: '600' }}>All Plant Drawings</h3>
...
export default PlantUploadDrawings;
