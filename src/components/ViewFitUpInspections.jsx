...
const ViewFitUpInspections = ({ setCurrentPage, onNewClick, onViewClick, onEditClick }) => {
  ...
  const [records] = useState([
    ...
    },
    {
      ...
      drawingTable: 'CHWP PUMP SKID - ASSEMBLY',
      status: 'IN PROGRESS'
    },
    {
      id: 3,
      ...
      drawingTable: 'CHWP PUMP SKID - TESTING',
      status: 'PENDING'
    }
  ]);
    ...
    <div className="enquiries-list">
      <div className="page-header">
        <div className="page-title">
          ...
          <h1>FIT UP Inspection Report</h1>
        </div>
      </div>
      ...
      <div className="list-controls">
        ...
        <button className="btn-new-transaction" onClick={handleNewRecord}>
          <i className="fas fa-plus"></i> New FIT-UP Inspection
        </button>
      </div>
...
export default ViewFitUpInspections;
