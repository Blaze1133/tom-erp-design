...
const EditDebitNote = ({ setCurrentPage }) => {
  ...
  useEffect(() => {
    const savedData = sessionStorage.getItem('selectedDebitNote');
    if (savedData) {
      const debitNote = JSON.parse(savedData);
      setFormData(prev => ({
        ...prev,
        ...debitNote
      }));
  ...
  return (
    <div className="enquiry-detail">
      ...
      <div className="detail-content">
        ...
        {/* Tabs Section - Same as Create screen */}
