...
const EmployeeHRSubTabsEdit = ({ hrSubTab, setHrSubTab }) => {
  const [empResidentialStatus, setEmpResidentialStatus] = React.useState('Foreigner');
  ...
  return (
    <div className="tab-content-wrapper">
      ...
      <div style={{ padding: '1.5rem', background: 'white' }}>
        ...
        {hrSubTab === 'basicInfo' && (
          <div className="detail-grid">
            <div className="detail-field">
              <label>EMP NATIONALITY <span className="required">*</span></label>
            ...
            <div className="detail-field">
              <label>EMP RESIDENTIAL STATUS <span className="required">*</span></label>
              <select 
                className="form-control" 
                value={empResidentialStatus}
                onChange={(e) => setEmpResidentialStatus(e.target.value)}
              >
                <option value="">Select Status</option>
            ...
            <div className="detail-field">
              <label>ETHNIC RACE <span className="required">*</span></label>
              <select className="form-control">
            ...
            {/* Conditional Fields based on EMP RESIDENTIAL STATUS */}
            {empResidentialStatus === 'Foreigner' && (
              <>
                <div className="detail-field">
                ...
                <div className="detail-field">
                  <label>WORK PERMIT/PASS TYPE <span className="required">*</span></label>
                  <select className="form-control">
                ...
                <div className="detail-field">
                  <label>WORK PERMIT START DATE <span className="required">*</span></label>
                  <input type="date" className="form-control" />
                </div>
                <div className="detail-field">
                ...
                <div className="detail-field">
                  <label>WORK PERMIT END DATE <span className="required">*</span></label>
                  <input type="date" className="form-control" />
                </div>
                <div className="detail-field">
            ...
            {empResidentialStatus === 'Singapore PR' && (
              <>
                <div className="detail-field">
                  <label>TYPE OF CONTRIBUTION FUND</label>
                  <input type="text" className="form-control" />
                ...
                <div className="detail-field">
                  <label>SINGAPORE PERMIT RESIDENCE START DATE <span className="required">*</span></label>
                  <input type="date" className="form-control" />
                </div>
                <div className="detail-field">
                  <label>PASSPORT EXPIRY DATE</label>
                ...
                <div className="detail-field">
                  <label>SINGAPORE PERMIT RESIDENCE END DATE <span className="required">*</span></label>
                  <input type="date" className="form-control" />
                </div>
                <div className="detail-field">
                  <label>EXPENSE LIMIT</label>
            ...
            {empResidentialStatus === 'Singaporean' && (
              <>
                <div className="detail-field">
                  <label>TYPE OF CONTRIBUTION FUND</label>
                  <input type="text" className="form-control" />
        ...
        {/* Employee Certification Sub-tab - Simplified */}
            ...
            <div className="detail-grid" style={{ marginBottom: '1rem' }}>
              <div className="form-group">
                ...
                <select className="form-control">
                  ...
                  <option value="Scaffolding Certificate">Scaffolding Certificate</option>
            ...
            <table className="detail-items-table">
              ...
              <tbody>
                {emergencyContactRows.map((row) => (
                  <tr key={row.id}>
                    <td><input type="text" className="form-control" value={row.name} onChange={(e) => handleEmergencyContactChange(row.id, 'name', e.target.value)} /></td>
                    <td><input type="text" className="form-control" value={row.relationship} onChange={(e) => handleEmergencyContactChange(row.id, 'relationship', e.target.value)} /></td>
                    <td><input type="text" className="form-control" value={row.emergencyAddress} onChange={(e) => handleEmergencyContactChange(row.id, 'emergencyAddress', e.target.value)} /></td>
                    <td><input type="text" className="form-control" value={row.emergencyPhone} onChange={(e) => handleEmergencyContactChange(row.id, 'emergencyPhone', e.target.value)} /></td>
                    <td>
            ...
            <table className="detail-items-table">
              ...
              <tbody>
                {disciplinaryRecords.length === 0 ? (
                  <tr>
                    <td colSpan="7" style={{ textAlign: 'center', padding: '1.5rem', color: '#999' }}>
                  ...
                  disciplinaryRecords.map((record) => (
                    <tr key={record.id}>
                      <td>{record.isWatch}</td>
                      <td>{record.startDate}</td>
                      <td>{record.reviewDate}</td>
                      <td>{record.endDate}</td>
                      <td>{record.memo}</td>
                      <td>{record.disciplinaryDocument?.name || '-'}</td>
                      <td>
                        <button className="btn btn-sm btn-secondary" style={{ fontSize: '0.75rem', padding: '0.25rem 0.5rem' }}>
                          <i className="fas fa-edit"></i>
                        </button>
        ...
        {hrSubTab === 'companyDocuments' && (
          <>
            <div className="detail-grid" style={{ gridTemplateColumns: 'repeat(2, 1fr)', marginBottom: '1rem' }}>
              <div className="form-group">
            ...
            <table className="detail-items-table">
              ...
              <tbody>
                <tr>
                  <td colSpan="3" style={{ textAlign: 'center', padding: '1.5rem', color: '#999' }}>
            ...
            <table className="detail-items-table">
              ...
              <tbody>
                {languageRows.map((row) => (
                  <tr key={row.id}>
                    <td>
                      <select className="form-control" value={row.language} onChange={(e) => handleLanguageChange(row.id, 'language', e.target.value)}>
                        <option value=""></option>
                    ...
                    <td>
                      <select className="form-control" value={row.proficiency} onChange={(e) => handleLanguageChange(row.id, 'proficiency', e.target.value)}>
                        <option value=""></option>
                    ...
                    <td>
                      <select className="form-control" value={row.knowledgeStatus} onChange={(e) => handleLanguageChange(row.id, 'knowledgeStatus', e.target.value)}>
                        <option value=""></option>
                    ...
                    <td>
                      <button className="btn btn-sm btn-secondary" onClick={() => handleRemoveLanguageRow(row.id)} style={{ fontSize: '0.75rem', padding: '0.25rem 0.5rem' }}>
                        <i className="fas fa-trash"></i>
                      </button>
                    </td>
                  </tr>
