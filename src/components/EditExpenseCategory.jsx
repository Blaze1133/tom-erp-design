...
const EditExpenseCategory = ({ setCurrentPage }) => {
  ...
  const [selectedSubsidiaries, setSelectedSubsidiaries] = useState([
    { name: 'Tech Onshore MEP Prefabricators Pte Ltd.', currency: 'SGD', selected: true },
  ...
  const handleSave = () => {
    ...
    showToast('Expense category saved successfully!', 'success');
    setTimeout(() => {
