...
const EditCustomerStatement = ({ setCurrentPage }) => {
  ...
  const parentCompanies = [
    ...
    '1007 DAIKINAIRCONDITIONNG(SINGAPORE)PTE.LTD'
  ];
    ...
    <div className="sales-quotation">
      ...
      <div className="quotation-container">
        <div style={{ marginBottom: '1.5rem', display: 'flex', gap: '0.5rem' }}>
          ...
          <button className="btn btn-secondary" onClick={() => showToast('Merge', 'info')}>
            Merge
          </button>
...
export default EditCustomerStatement;
