...
const ViewTransferOrders = ({ setCurrentPage }) => {
  const [viewType, setViewType] = useState('Search Project');

  // Dummy data for transfer orders
  const transferOrders = [
    {
      ...
      name: 'Material Transfer - Project Alpha',
      account: 'Inventory Transfer',
      memo: 'Monthly material transfer',
      item: 'Steel Plates',
      itemQty: 150,
      itemUnitPrice: 45.50,
      amount: 6825.00
    ...
    },
    {
      id: 3,
      date: '6/11/2025',
      documentNumber: 'TO2025-003',
      vendor: 'Tech Offshore Marine (DQ) Pte Ltd',
      name: 'Hydraulic Components',
      account: 'Inventory Transfer',
      memo: 'Transfer for maintenance',
      item: 'Hydraulic Oil',
      itemQty: 200,
      itemUnitPrice: 8.75,
      amount: 1750.00
  ...
  const handleRowClick = (order) => {
    setCurrentPage('view-transfer-order-detail');
  };

  const handleNewTransaction = () => {
    setCurrentPage('enter-transfer-orders');
  };
    ...
    <div style={{ background: '#f5f5f5', minHeight: '100vh' }}>
      ...
      <div style={{ 
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
          ...
          <h1 style={{ margin: 0, fontSize: '20px', fontWeight: '600' }}>Transfer Orders</h1>
        </div>
        ...
        <div style={{ background: 'white', borderRadius: '8px', padding: '20px' }}>
          ...
          <div style={{ 
            ...
            <div style={{ display: 'flex', gap: '12px', alignItems: 'center' }}>
              ...
              <span style={{ fontSize: '13px', color: '#666', fontWeight: '500' }}>TOTAL: {transferOrders.length}</span>
            </div>
          </div>
...
export default ViewTransferOrders;
