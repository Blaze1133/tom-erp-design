...
const EditFwlQualification = ({ onSave, onCancel, selectedQualification }) => {
  ...
  const [formData, setFormData] = useState({
    name: selectedQualification?.name || 'Construction Work Permit Holder Basic Tier-300',
    fwlDaily: '9.87',
    fwlPerMonth: '300.00',
    appliedPermitPassType: 'WORK PERMIT'
  });
  ...
  const handleSave = () => {
    ...
    showToast('FWL Qualification updated successfully!', 'success');
    if (onSave) {
      onSave(formData);
    }
  };
...
export default EditFwlQualification;
