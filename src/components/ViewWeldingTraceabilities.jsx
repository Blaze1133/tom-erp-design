...
const ViewWeldingTraceabilities = ({ setCurrentPage, onNewClick, onViewClick, onEditClick }) => {
    ...
    <div className="enquiries-list">
      <div className="page-header">
        <div className="page-title">
          <i className="fas fa-burn" style={{ fontSize: '24px', color: '#4a90e2' }}></i>
          <h1>Welding Traceability Report</h1>
        </div>
      </div>
      ...
      <div className="list-controls">
        ...
        <button className="btn-new-transaction" onClick={handleNewRecord}>
          <i className="fas fa-plus"></i> New Welding Traceability
        </button>
      </div>
...
export default ViewWeldingTraceabilities;
