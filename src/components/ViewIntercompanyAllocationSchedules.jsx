...
const ViewIntercompanyAllocationSchedules = ({ setCurrentPage }) => {
  ...
  const [schedules] = useState([
    ...
    {
      id: 2,
      name: 'Cross-Entity Expense Distribution',
      nextDate: '31/03/2025',
    ...
    {
      id: 4,
      name: 'Annual Intercompany Settlement',
      nextDate: '31/12/2024',
    ...
    {
      id: 5,
      name: 'Bi-Weekly Transfer Pricing',
      nextDate: '20/11/2024',
      enter: 'Tech Onshore MEP',
  ...
  const handleView = (schedule) => {
    if (setCurrentPage) {
      setCurrentPage('view-intercompany-allocation-schedule-detail');
    }
  };
    ...
    <div className="enquiries-list">
      <div className="list-header">
        <div className="list-title">
          ...
          <h1>Intercompany Allocation Schedules</h1>
        </div>
      ...
      <div className="filters-section" style={{ background: '#f8f9fa', padding: '20px', marginBottom: '0' }}>
        <div className="filter-row" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <div style={{ display: 'flex', gap: '15px', alignItems: 'center' }}>
            ...
            <button className="btn-filter-primary" onClick={() => setCurrentPage && setCurrentPage('create-intercompany-allocation-schedules')} style={{ padding: '8px 20px', background: '#4a90e2', color: 'white', border: 'none', borderRadius: '4px', fontSize: '14px', fontWeight: '500' }}>
              <i className="fas fa-plus"></i> New Intercompany Allocation Schedule
            </button>
          </div>
        </div>
      </div>
...
export default ViewIntercompanyAllocationSchedules;
