...
const EditReturnAuthorization = ({ setCurrentPage }) => {
  ...
  const handleSave = () => {
    ...
    showToast('Return Authorization updated successfully!', 'success');
    ...
    <div className="sales-quotation">
      <div className="page-header">
        <div className="page-title">
          ...
          <h1>Edit Return Authorization #{formData.rmaAuth}</h1>
        </div>
                  ...
                  <tbody>
                    {items.map((item) => (
                      <tr key={item.id}>
                        ...
                        <td><input type="text" className="form-control" value={item.item} style={{ minWidth: '150px' }} /></td>
                        ...
                        <td><input type="text" className="form-control" value={item.description} style={{ minWidth: '200px' }} /></td>
                        <td><input type="text" className="form-control" value={item.priceLevel} style={{ width: '100px' }} /></td>
                        <td><input type="text" className="form-control" value={item.unitPrice} style={{ width: '100px' }} /></td>
                        <td><input type="text" className="form-control" value={item.code} style={{ width: '80px' }} /></td>
                        <td><input type="text" className="form-control" value={item.amount} style={{ width: '100px' }} /></td>
                        <td><input type="text" className="form-control" value={item.costRate} style={{ width: '100px' }} /></td>
                        ...
                        <td><input type="checkbox" checked={item.closed} /></td>
                        <td><input type="text" className="form-control" value={item.estimatedExtendedCost} style={{ width: '120px' }} /></td>
                        <td><input type="text" className="form-control" value={item.serialNumbers} style={{ minWidth: '150px' }} /></td>
                      </tr>
                    ))}
                  </tbody>
                </table>
...
export default EditReturnAuthorization;
