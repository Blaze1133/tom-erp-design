...
const ViewIntercompanyTransferOrderDetail = ({ setCurrentPage }) => {
  // Dummy data
  const orderData = {
      ...
      <div style={{ 
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '20px' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
            ...
            <div>
              <div style={{ fontSize: '12px', color: '#999', marginBottom: '4px', letterSpacing: '0.5px' }}>Intercompany Transfer Order</div>
        ...
        <div style={{ background: 'white', borderRadius: '8px', marginBottom: '20px', border: '1px solid #e0e0e0' }}>
          ...
          <div style={{ padding: '24px' }}>
            <div style={{ 
              ...
              <div>
                <div style={{ fontSize: '11px', fontWeight: '600', color: '#999', textTransform: 'uppercase', marginBottom: '8px', letterSpacing: '0.5px' }}>REF NO.</div>
                <div style={{ color: '#333', fontSize: '14px' }}>{orderData.refNo}</div>
              </div>
              <div>
              ...
              <div>
                <div style={{ fontSize: '11px', fontWeight: '600', color: '#999', textTransform: 'uppercase', marginBottom: '8px', letterSpacing: '0.5px' }}>TO SUBSIDIARY</div>
                <div style={{ color: '#333', fontSize: '14px' }}>{orderData.toSubsidiary}</div>
              </div>
              <div>
...
export default ViewIntercompanyTransferOrderDetail;
