...
const ViewAccountingListDetail = ({ setCurrentPage }) => {
    ...
    <div className="sales-quotation">
      <div style={{ 
        ...
        <div style={{ display: 'flex', gap: '8px', alignItems: 'center' }}>
          <button className="btn-view-option" onClick={() => showToast('List', 'info')} style={{ padding: '6px 12px', fontSize: '13px' }}>List</button>
...
export default ViewAccountingListDetail;
