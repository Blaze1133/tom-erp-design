...
const ViewCustomers = ({ onNewClick, onViewClick, onEditClick }) => {
  ...
  // Dashboard metrics
  const totalOutstanding = 125450.75;
  const totalInvoices = 342;
  const pendingPayments = 28;
  const paidThisMonth = 89750.50;
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '1rem' }}>
          ...
          <div style={{ 
            ...
            <div style={{ 
              ...
              <i className="fas fa-money-bill-wave" style={{ fontSize: '20px', color: '#fff' }}></i>
            </div>
          </div>
          ...
          <div style={{ 
            ...
            <div style={{ 
              ...
              <i className="fas fa-file-invoice" style={{ fontSize: '20px', color: '#fff' }}></i>
            </div>
          </div>
          ...
          <div style={{ 
            ...
            <div style={{ 
              ...
              <i className="fas fa-users" style={{ fontSize: '20px', color: '#fff' }}></i>
            </div>
          </div>
        </div>
      </div>
