...
const EditCustomerDeposit = ({ setCurrentPage }) => {
  ...
  const handleSave = () => {
    ...
    showToast('Customer Deposit updated successfully!', 'success');
    ...
    <div className="sales-quotation">
      <div className="page-header">
        <div className="page-title">
          ...
          <h1>Edit Customer Deposit {formData.deposit}</h1>
        </div>
...
export default EditCustomerDeposit;
