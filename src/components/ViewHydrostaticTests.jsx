...
const ViewHydrostaticTests = ({ setCurrentPage, onNewClick, onViewClick, onEditClick }) => {
  ...
  const [records] = useState([
    ...
    },
    {
      ...
      reportNo: 'TOM-YSE-2024-00221-HTR-002',
      status: 'IN PROGRESS'
    },
    {
      id: 3,
      ...
      reportNo: 'TOM-YSE-2024-00221-HTR-003',
      status: 'PENDING'
    }
  ]);
    ...
    <div className="enquiries-list">
      <div className="page-header">
        <div className="page-title">
          <i className="fas fa-tint" style={{ fontSize: '24px', color: '#4a90e2' }}></i>
          <h1>All Hydrostatic Tests</h1>
        </div>
      </div>
      ...
      <div className="list-controls">
        ...
        <button className="btn-new-transaction" onClick={handleNewRecord}>
          <i className="fas fa-plus"></i> New Hydrostatic Test
        </button>
      </div>
...
export default ViewHydrostaticTests;
