...
const CreatePayPeriod = ({ onBack, onSave, calendarData }) => {
  const [toast, setToast] = useState({ show: false, message: '', type: 'success' });
  const [notesCollapsed, setNotesCollapsed] = useState(false);
  const [formData, setFormData] = useState({
    customForm: 'Standard Pay Period Form',
    name: '',
    inactive: false,
    calendarDays: '',
    publicHoliday: '',
    refCalendarYear: calendarData?.name || '2021 (MEP)',
    srNo: '',
    monthStartDate: '',
    monthEndDate: '',
    closePeriod: false,
          ...
          <div className="section-body">
            <div className="detail-grid">
              <div className="detail-field">
                <label>CUSTOM FORM <span style={{ color: 'red' }}>*</span></label>
                <select
                  name="customForm"
                ...
                >
                  <option>Standard Pay Period Form</option>
                  <option>Custom Pay Period Form</option>
                </select>
              </div>
              <div className="detail-field">
                <label>REF CALENDER YEAR</label>
                <div className="field-value">{formData.refCalendarYear}</div>
              </div>
              <div className="detail-field">
