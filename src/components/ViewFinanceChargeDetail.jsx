...
const ViewFinanceChargeDetail = ({ setCurrentPage }) => {
    ...
    <div className="enquiry-detail">
      <div className="detail-header">
        <div className="detail-title">
          ...
          <div>
            <h1>Finance Charge</h1>
            <div className="detail-subtitle">
              <span>{chargeData.transactionNumber}</span>
            </div>
          </div>
        </div>
          ...
          <div className="section-body">
            <div className="detail-grid">
              <div className="detail-field">
                ...
                <div className="field-value">{chargeData.transactionNumber}</div>
              </div>
              <div className="detail-field">
                <label>A/R ACCOUNT</label>
                <div className="field-value">{chargeData.arAccount}</div>
              </div>
              <div className="detail-field">
                <label>DATE</label>
                <div className="field-value">{chargeData.date}</div>
              </div>
              <div className="detail-field">
                <label>POSTING PERIOD</label>
                <div className="field-value">{chargeData.postingPeriod}</div>
              </div>
              <div className="detail-field">
                <label>AMOUNT</label>
                <div className="field-value">{chargeData.amount}</div>
              </div>
              <div className="detail-field">
                <label>TO BE PRINTED</label>
                <div className="field-value">{chargeData.toBePrinted}</div>
              </div>
              <div className="detail-field">
                <label>TO BE EMAILED</label>
                <div className="field-value">{chargeData.toBeEmailed}</div>
              </div>
              <div className="detail-field">
                <label>TO BE FAXED</label>
                <div className="field-value">{chargeData.toBeFaxed}</div>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="section-body">
            <div className="detail-grid">
              <div className="detail-field">
                ...
                <div className="field-value">{chargeData.salesRep || '-'}</div>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="section-body">
            <div className="detail-grid">
              <div className="detail-field">
                ...
                <div className="field-value">{chargeData.subsidiary}</div>
              </div>
              <div className="detail-field">
                <label>CLASS</label>
                <div className="field-value">{chargeData.class || '-'}</div>
              </div>
              <div className="detail-field">
                <label>LOCATION</label>
                <div className="field-value">{chargeData.location || '-'}</div>
              </div>
              <div className="detail-field">
                <label>DEPARTMENT</label>
                <div className="field-value">{chargeData.department || '-'}</div>
              </div>
            </div>
          </div>
        </div>
...
export default ViewFinanceChargeDetail;
