...
const CreateDeliveryOrder = ({ setCurrentPage }) => {
  ...
  const handleSave = () => {
    if (!formData.customer || !formData.subsidiary || !formData.location) {
      showToast('Please fill in all required fields (Customer, Subsidiary, Location)', 'error');
      return;
    }
    ...
    <div className="enquiry-detail">
      ...
      <div className="detail-header">
        <div className="detail-title">
          ...
          <div>
            <h1>New Delivery Order / Item Fulfillment</h1>
