...
const CreateTask = ({ isEdit = false, onSave, onCancel }) => {
  ...
  const [formData, setFormData] = useState({
    taskId: isEdit ? 'TSK001' : '',
    taskName: isEdit ? 'MEP Installation - Phase 1' : '',
          ...
          <div className="section-body">
            <div className="detail-grid">
              <div className="detail-field">
                <label>TASK ID <span style={{color: 'orange'}}>*</span></label>
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                  <input type="text" className="form-control" value={formData.taskId} onChange={(e) => handleInputChange('taskId', e.target.value)} placeholder="To Be Generated" />
              ...
              <div className="detail-field">
                <label>TASK NAME <span style={{color: 'orange'}}>*</span></label>
                <input type="text" className="form-control" value={formData.taskName} onChange={(e) => handleInputChange('taskName', e.target.value)} />
              </div>
              <div className="detail-field">
              ...
              <div className="detail-field">
                <label>PRIORITY <span style={{color: 'orange'}}>*</span></label>
                <select className="form-control" value={formData.priority} onChange={(e) => handleInputChange('priority', e.target.value)}>
        ...
        <div className={`detail-section ${scheduleCollapsed ? 'collapsed' : ''}`}>
          ...
          <div className="section-body">
            <div className="detail-grid">
              ...
              <div className="detail-field">
                <label>DUE DATE <span style={{color: 'orange'}}>*</span></label>
                <input type="date" className="form-control" value={formData.dueDate} onChange={(e) => handleInputChange('dueDate', e.target.value)} />
              </div>
              <div className="detail-field">
              ...
              <div className="detail-field">
                ...
                <input type="number" className="form-control" value={formData.estimatedHours} onChange={(e) => handleInputChange('estimatedHours', e.target.value)} />
              </div>
              <div className="detail-field">
                <label>ACTUAL HOURS</label>
                <input type="number" className="form-control" value={formData.actualHours} onChange={(e) => handleInputChange('actualHours', e.target.value)} />
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="section-body">
            <div className="detail-grid">
              ...
              <div className="detail-field">
                ...
                <select className="form-control" value={formData.taskClass} onChange={(e) => handleInputChange('taskClass', e.target.value)}>
                  <option value=""></option>
