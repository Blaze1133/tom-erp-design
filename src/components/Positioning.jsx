...
const Positioning = ({ setCurrentPage, viewOnly = false, viewData = null, returnPageId = '' }) => {
  ...
  const handleSubmit = () => {
    ...
    localStorage.setItem('positioningStatus', formData.completionStatus);
    localStorage.setItem('positioningCompletedOn', formData.completedOn);
    ...
    showToast('Positioning status updated successfully!', 'success');
