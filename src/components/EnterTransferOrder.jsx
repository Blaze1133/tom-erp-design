...
const EnterTransferOrder = ({ setCurrentPage }) => {
    ...
    <div className="quotation-container">
      ...
      <div className="page-header">
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
          ...
          <h1 className="page-title">Transfer Order</h1>
        </div>
  ...
  >
    ...
    <option value="TOM22-00656 TEAM LEAD CONSTRUCTION PTE LTD : 25-00003-TLC-Nursing Home @ Hougang Ave 1">
...
export default EnterTransferOrder;
