...
const ViewMaterialTraceabilities = ({ setCurrentPage, onNewClick, onViewClick, onEditClick }) => {
    ...
    <div className="enquiries-list">
      <div className="page-header">
        <div className="page-title">
          <i className="fas fa-barcode" style={{ fontSize: '24px', color: '#4a90e2' }}></i>
          <h1>All Material Traceability Tests</h1>
        </div>
      </div>
      ...
      <div className="list-controls">
        ...
        <button className="btn-new-transaction" onClick={handleNewRecord}>
          <i className="fas fa-plus"></i> New Material Traceability
        </button>
      </div>
...
export default ViewMaterialTraceabilities;
