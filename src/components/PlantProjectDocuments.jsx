...
const PlantProjectDocuments = () => {
  ...
  // Sample document records for Plant
  const [documentRecords] = useState([
    {
      id: 1,
      documentName: 'Plant Incoming Inspection report',
      documentType: 'Material Inspection',
      project: 'Plant Construction Phase 1',
      revisionNo: '0',
      fileUploaded: 'PLANT-IR-01.pdf',
      moduleNo: 'PLANT-001'
    },
    {
      id: 2,
      ...
      project: 'Plant Construction Phase 1',
      revisionNo: '0',
      fileUploaded: 'PLANT-IR-02.pdf',
      moduleNo: 'PLANT-002'
    },
    {
      id: 3,
      documentName: 'Plant Quality Assurance',
      documentType: 'Quality Assurance',
      project: 'Plant Construction Phase 2',
      revisionNo: '1',
      fileUploaded: 'PLANT-QA-01.pdf',
      moduleNo: 'PLANT-003'
    },
    {
      id: 4,
      documentName: 'Plant Test Report',
      documentType: 'Test Report',
      project: 'Plant Construction Phase 2',
      revisionNo: '0',
      fileUploaded: 'PLANT-TR-01.pdf',
      moduleNo: 'PLANT-004'
    },
    {
      id: 5,
      documentName: 'Plant Compliance Certificate',
      documentType: 'Compliance Certificate',
      project: 'Plant Construction Phase 3',
      revisionNo: '0',
      fileUploaded: 'PLANT-CC-01.pdf',
      moduleNo: 'PLANT-005'
    }
  ]);
  ...
  const handleSubmit = () => {
    ...
    showToast('Plant document uploaded successfully!', 'success');
      ...
      <div className="quotation-container">
        ...
        <div className="form-section" style={{ backgroundColor: 'white', padding: '2rem', borderRadius: '8px', marginBottom: '2rem' }}>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '2rem', marginBottom: '2rem' }}>
            ...
            <div className="form-group">
              ...
              >
                <option value="">Select</option>
                <option value="Plant Construction Phase 1">Plant Construction Phase 1</option>
                <option value="Plant Construction Phase 2">Plant Construction Phase 2</option>
                <option value="Plant Construction Phase 3">Plant Construction Phase 3</option>
                <option value="Plant Expansion Project">Plant Expansion Project</option>
              </select>
            </div>
        ...
        <div className="form-section">
          <div style={{ 
            ...
            <h3 style={{ margin: 0, fontSize: '1rem', fontWeight: '600' }}>All Plant Project Documents</h3>
...
export default PlantProjectDocuments;
