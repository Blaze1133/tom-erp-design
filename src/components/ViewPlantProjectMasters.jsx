...
const ViewPlantProjectMasters = ({ onNewClick, onViewClick, onEditClick }) => {
  ...
  const [projects] = useState([
    ...
    },
    {
      id: 2,
      projectId: 'PLT002',
      projectName: 'Assembly Line Setup',
      clientName: 'Manufacturing Solutions Ltd',
      poNo: 'PO-PLT-2024-002',
      mainCon: 'Main Contractor Beta',
      status: 'Active',
    ...
    },
    {
      id: 3,
      projectId: 'PLT003',
      projectName: 'Production Facility Upgrade',
      clientName: 'Factory Systems Inc',
      poNo: 'PO-PLT-2024-003',
      mainCon: 'Main Contractor Gamma',
      status: 'Completed',
    ...
    },
    {
      ...
      clientName: 'Logistics Partners Pte Ltd',
      poNo: 'PO-PLT-2024-004',
      mainCon: 'Main Contractor Delta',
      status: 'Active',
    ...
    },
    {
      ...
      clientName: 'Quality Assurance Co',
      poNo: 'PO-PLT-2024-005',
      mainCon: 'Main Contractor Epsilon',
      status: 'In Progress',
...
export default ViewPlantProjectMasters;
