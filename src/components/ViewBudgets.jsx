      ...
      <div className="filters-section" style={{ background: '#f8f9fa', padding: '20px', marginBottom: '0' }}>
        <div className="filter-row" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <div style={{ display: 'flex', gap: '15px', alignItems: 'center' }}>
            ...
            <button className="btn-filter-primary" onClick={() => setCurrentPage && setCurrentPage('set-up-budgets')} style={{ padding: '8px 20px', background: '#4a90e2', color: 'white', border: 'none', borderRadius: '4px', fontSize: '14px', fontWeight: '500' }}>
