...
const NewSubsidiary = ({ setCurrentPage }) => {
  ...
  const [formData, setFormData] = useState({
    ...
    alwaysDisplaySubsidiaryName: false,
    subsidiaryLogo: '',
    subsidiaryLogoImages: '',
    webSite: '',
  ...
  const handleSave = () => {
    if (!formData.name) {
      showToast('Please enter a subsidiary name', 'error');
      return;
    }
  ...
  return (
    <div className="sales-quotation">
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '12px 20px' }}>
          ...
          <div className="form-group">
            ...
            >
              ...
              <option value="TOM(S) DBS BANK USD">TOM(S) DBS BANK USD</option>
            </select>
          </div>
      ...
      <div className="tab-content" style={{ padding: '20px', minHeight: '200px' }}>
        {activeTab === 'addresses' && (
          <div style={{ color: '#666' }}>
            <p>Address information can be added here.</p>
          </div>
        )}
        {activeTab === 'document-numbers' && (
          <div style={{ color: '#666' }}>
            <p>Document Numbers can be configured here.</p>
          </div>
        )}
      </div>
