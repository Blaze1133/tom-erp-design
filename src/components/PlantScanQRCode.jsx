...
const PlantScanQRCode = ({ setCurrentPage }) => {
  ...
  // QR Code to Dashboard mapping for Plant Module
  const qrCodeMappings = {
    'SANYU-CHWP-01': 'plant-dashboard',
    'SANYU-CHWP-001': 'plant-dashboard',
    'TOM-P-001': 'plant-dashboard',
    'PLANT-001': 'plant-dashboard',
    'PLANT-002': 'plant-dashboard',
    'PLANT-003': 'plant-dashboard',
    'PLANT-FAB-001': 'plant-dashboard',
    'PLANT-ASSY-001': 'plant-dashboard',
    'PLANT-QC-001': 'plant-dashboard',
    'PLANT-PKG-001': 'plant-dashboard'
  };
      ...
      <div className="quotation-container">
        ...
        <div className="form-section" style={{ 
          ...
          <ul style={{ 
            ...
            <li>Point the camera at the Plant module QR code until it's detected automatically</li>
            ...
            <li>Valid Plant QR codes will redirect you to the appropriate dashboard</li>
          </ul>
        </div>
      </div>
...
export default PlantScanQRCode;
