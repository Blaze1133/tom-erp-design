...
const UnrealizedExchangeGainsLosses = ({ onViewDetailClick }) => {
  ...
  const handleRefresh = () => {
    showToast('Unrealized Exchange Rate Gains and Losses refreshed successfully', 'success');
  };
    ...
    <div className="sales-quotation">
      <div className="page-header">
        <div className="page-title">
          ...
          <h1>Unrealized Exchange Rate Gains and Losses</h1>
        </div>
      ...
      <div className="quotation-container">
        ...
        {/* Unrealized Exchange Rate Gains and Losses Table */}
        <div className="form-section">
          <div style={{ 
            display: 'flex', 
            ...
            <h2 className="section-title" style={{ margin: 0, flex: '1 1 auto', minWidth: '300px' }}>
              ...
              Unrealized Exchange Rate Gains and Losses - {fromDate} to {toDate}
            </h2>
            <span style={{ 
              fontSize: '0.85rem', 
              color: '#666',
...
export default UnrealizedExchangeGainsLosses;
